...
window.electronAPI.printReceipt({ receiptId: '123', amount: 50000 }); 

Electron receives this in main.js, generates the PDF locally, and sends it to the default Windows printer.
